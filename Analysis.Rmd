...
RepAnth$SD = sd(Dup$Anth)
RepAnth = as.data.frame(RepAnth)
RepAnth$Measure = "Anth"

#Chlorophyll
RepChl = summary(Dup$Chl)
RepChl$SD = sd(Dup$Chl)
RepChl = as.data.frame(RepChl)
RepChl$Measure = "Chl"


#Flavanoid
RepFlav = summary(Dup$Flav)
RepFlav$SD = sd(Dup$Flav)
RepFlav = as.data.frame(RepFlav)
RepFlav$Measure = "Flav"

#NBI
RepNBI =summary(Dup$NBI)
RepNBI$SD = sd(Dup$NBI)
RepNBI = as.data.frame(RepNBI)
RepNBI$Measure = "NBI"


RepMeasure = rbind(RepAnth,RepChl,RepFlav,RepNBI)
RepMeasure[c(8,1:7)]
```
...
Dup2 = summarise(Dup2, Anth_mean = mean(Anth, na.rm = T), Anth_sd = sd(Anth, na.rm = T), Chl_mean = mean(Chl, na.rm = T), Chl_sd = sd(Chl, na.rm=T ), Flav_mean = mean(Flav,na.rm = T), Flav_sd = sd(Flav, na.rm = T), NBI_mean = mean(NBI, na.rm = T), NBI_sd = sd(NBI, na.rm = T))
Dup2
```
...
#Anth Mean Plot
RMA <-ggplot(Dup) +aes(x = Tree.ID, y = Anth, colour = Rep.,fill = Rep.) + geom_point() +geom_hline(yintercept = mean(Dup$Anth), colour = "dodgerblue1")+ ylab("Anthocyanin") + xlab("Tree ID") + ggtitle("Anthocyanin Absorbance of Replicated Samples vs Tree ID") +theme_bw() +theme(plot.title = element_text(hjust = 0.5))

#Histogram of Measurement Distribution
RHA <-ggplot(Dup) +aes(Anth,color=Rep., fill=Rep.) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Anthocyanin") + ggtitle("Anthocyanin Distribution of Replicate Samples") +theme_bw() +theme(plot.title = element_text(hjust = 0.5))
...
RBC <- ggplot(Dup) + aes(x = Rep., y = Chl) + geom_boxplot(fill = "dodgerblue1", size = 1.25)+ ylab("Surface Chlorophyll (g/cm2)") + xlab("Replicate Number") + ggtitle("Chlorophyll Distribution and Mean of Replicate Groups")+stat_summary(fun.y=mean, colour="gray90", geom="point", shape=18, size=5) +theme_bw()+theme(plot.title = element_text(hjust = 0.5))+geom_hline(yintercept = mean(Dup$Chl));RBC
...
RHC <-ggplot(Dup) +aes(Chl,color=Rep., fill=Rep.) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Surface Chlorophyll") + ggtitle("Chlorophyll Distribution of Replicate Samples") +theme_bw() +theme(plot.title = element_text(hjust = 0.5))
...
RHF <-ggplot(Dup) +aes(Flav,color=Rep., fill=Rep.) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Flavonol Absorbance") + ggtitle("Flavonol Distribution of Replicate Samples") +theme_bw() +theme(plot.title = element_text(hjust = 0.5))
...
RBN <- ggplot(Dup) + aes(x = Rep., y = NBI) + geom_boxplot(fill = "dodgerblue1", size = 1.25)+ ylab("Nitrogen Balance Index") + xlab("Replicate Number") + ggtitle("Nitrogen Distribution and Mean of Replicate Groups")+stat_summary(fun.y=mean, colour="gray90", geom="point", shape=18, size=5) +theme_bw()+theme(plot.title = element_text(hjust = 0.5)) +geom_hline(yintercept = mean(Dup$NBI));RBN

#NBI Mean Plot
RMN <-ggplot(Dup) +aes(x = Tree.ID, y = NBI, colour = Rep.,fill = Rep.) + geom_point() +geom_hline(yintercept = mean(Dup$NBI), colour = "dodgerblue1")+ ylab("NBI") + xlab("Tree ID") + ggtitle("Nitrogen Balance Index(NBI) of Replicate Samples")+theme_bw()+theme(plot.title = element_text(hjust = 0.5))

#Histogram of NBI Measurement Distribution
RHN <-ggplot(Dup) +aes(NBI,color=Rep., fill=Rep.) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("NBI") + ggtitle("NBI Distribution of Replicate Samples") +theme_bw() +theme(plot.title = element_text(hjust = 0.5))
...
anova(mod3)
AnthRep = summary(mod3)$r.squared
```
...
anova(mod2)
FlavRep = summary(mod2)$r.squared
```
...
anova(mod4)
NBIRep = summary(mod4)$r.squared

Replicate = rbind(AnthRep,ChlRep,FlavRep,NBIRep)
R2 = c("Rsquared","Pvalue")
rbind(R2,Replicate)
```
...
ABF<- ggplot(Data) + aes(x = Allocation, y = Flav) + geom_boxplot(fill = "dodgerblue1", size = 1)+ ylab("Flavonol") + xlab("Allocation") + ggtitle("Flav Absorbance of Allocations")+stat_summary(fun.y=mean, colour="green", geom="point", shape=18, size=3) +theme_bw()+theme(plot.title = element_text(hjust = 0.5)) +geom_hline(yintercept = mean(Data$Flav))
...
PBA <- ggplot(Parent) + aes(x = Tree.ID, y = Anth,) + geom_boxplot(fill = "dodgerblue1", size = 1.25) + ylab("Anthocyanin Abosorbance") + xlab("Parent Tree") + ggtitle("Anthocyanin Absorbance Distributions and Means of Parent Trees") +stat_summary(fun.y=mean, colour="gray90", geom="point", shape=18, size=5) +theme_bw()+theme(plot.title = element_text(hjust = 0.5))+geom_hline(yintercept = mean(Parent$Anth));PBA

#Anth Mean Plot
PMA<-ggplot(Parent) +aes(x = measure, y = Anth, colour = Tree.ID, fill = Tree.ID) + geom_point() +geom_hline(yintercept = mean(Parent$Anth), colour = "dodgerblue1")+ ylab("Anthocyanin Absorbance") + xlab("Measure Number") + ggtitle("Anthocyanin of Parent Samples")+theme_bw()+theme(plot.title = element_text(hjust = 0.5))

#Histogram of Measurement Distribution
PHA <-ggplot(Parent) +aes(Anth,color=Tree.ID, fill=Tree.ID) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Anthocyanin Absorbance") + ggtitle("Anthocyanin Absorbance Distribution of Parents") +theme_bw() +theme(plot.title = element_text(hjust = 0.5))
...
PBC<- ggplot(Parent) + aes(x = Tree.ID, y = Chl,) + geom_boxplot(fill = "dodgerblue1", size = 1.25) + ylab("Surface Chlorophyll (g/cm2)") + xlab("Parent Tree") + ggtitle("Surface Chlorophyll Distribution and Means of Parent Trees") +stat_summary(fun.y=mean, colour="gray90", geom="point", shape=18, size=5) +theme_bw()+theme(plot.title = element_text(hjust = 0.5))+geom_hline(yintercept = mean(Parent$Chl));PBC
...
PBF<- ggplot(Parent) + aes(x = Tree.ID, y = Flav,) + geom_boxplot(fill = "dodgerblue1", size = 1.25) + ylab("Flavonol Absorbance") + xlab("Parent Tree") + ggtitle("Flavonol Absorbance Distribution and Means of Parent Trees") +stat_summary(fun.y=mean, colour="gray90", geom="point", shape=18, size=5) +theme_bw()+theme(plot.title = element_text(hjust = 0.5))+geom_hline(yintercept = mean(Parent$Flav));PBF
...
summary(lm(Parent$Chl ~ Parent$Tree.ID))$r.squared
```
...
summary(lm(Parent$Flav ~ Parent$Tree.ID))$r.squared
```
...
summary(lm(Parent$NBI ~ Parent$Tree.ID))$r.squared
```
...
#Nitrogen ANOVA
FAN = lm(F1$NBI ~ F1$Tree.ID)
anova(FAN)
summary(FAN)$r.squared
```
...
```{r}
HvLA = ggplot(HighLow) +aes(Anth,color=Height, fill=Height) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Anthocyanin") + ggtitle("Anthocyanin by Height") +theme_bw() +theme(plot.title = element_text(hjust = 0.5)); HvLA
...
```{r}
HvMA = ggplot(HighMid) +aes(Anth,color=Height, fill=Height) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Anthocyanin") + ggtitle("Anthocyanin by Height") +theme_bw() +theme(plot.title = element_text(hjust = 0.5));HvMA

AHMA = lm(High$Anth ~ Mid$Anth)
anova(AHMA)
summary(AHMA)
```
...
```{r}
MvLA = ggplot(MidLow) +aes(Anth,color=Height, fill=Height) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Anthocyanin") + ggtitle("Anthocyanin by Height") +theme_bw() +theme(plot.title = element_text(hjust = 0.5));MvLA

AMLA = lm(Mid$Anth ~ Low$Anth)
anova(AMLA)
summary(AMLA)
```
...
```{r}
HvLC = ggplot(HighLow) +aes(Chl,color=Height, fill=Height) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Chlorophyll") + ggtitle("Chlorophyll by Height") +theme_bw() +theme(plot.title = element_text(hjust = 0.5)); HvLC


AHLC = lm(High$Chl ~ Low$Chl)
anova(AHLC)
summary(AHLC)
```
...
```{r}
HvMC = ggplot(HighMid) +aes(Chl,color=Height, fill=Height) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Chlorophyll") + ggtitle("Chlorophyll by Height") +theme_bw() +theme(plot.title = element_text(hjust = 0.5));HvMC

AHMC = lm(High$Chl ~ Mid$Chl)
anova(AHMC)
summary(AHMC)
```
...
```{r}
MvLC = ggplot(MidLow) +aes(Chl,color=Height, fill=Height) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Chlorophyll") + ggtitle("Chlorophyll by Height") +theme_bw() +theme(plot.title = element_text(hjust = 0.5));MvLC

AMLC = lm(Mid$Chl ~ Low$Chl)
anova(AMLC)
summary(AMLC)
```
...
```{r}
HvLF= ggplot(HighLow) +aes(Flav,color=Height, fill=Height) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Flavonol") + ggtitle("Flavonol by Height") +theme_bw() +theme(plot.title = element_text(hjust = 0.5)); HvLF

AHLF = lm(High$Flav ~ Low$Flav)
anova(AHLF)
summary(AHLF)
```
...
```{r}
HvMF = ggplot(HighMid) +aes(Flav,color=Height, fill=Height) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Flavonol") + ggtitle("Flavonol by Height") +theme_bw() +theme(plot.title = element_text(hjust = 0.5)); HvMF

AHMF = lm(High$Flav ~ Mid$Flav)
anova(AHMF)
summary(AHMF)
```
...
```{r}
MvLF = ggplot(MidLow) +aes(Flav,color=Height, fill=Height) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("Flavonol") + ggtitle("Flavonol by Height") +theme_bw() +theme(plot.title = element_text(hjust = 0.5)); MvLF

AMLF = lm(Mid$Flav ~ Low$Flav)
anova(AMLF)
summary(AMLF)
```
...
```{r}
HvLN = ggplot(HighLow) +aes(NBI,color=Height, fill=Height) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("NBI") + ggtitle("Nitrogen by Height") +theme_bw() +theme(plot.title = element_text(hjust = 0.5)); HvLN

AHLN = lm(High$NBI ~ Low$NBI)
anova(AHLN)
summary(AHLN)
```
...
```{r}
HvMN = ggplot(HighMid) +aes(NBI,color=Height, fill=Height) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("NBI") + ggtitle("Nitrogen by Height") +theme_bw() +theme(plot.title = element_text(hjust = 0.5)); HvMN

AHMN = lm(High$NBI ~ Mid$NBI)
anova(AHMN)
summary(AHMN)
```
...
```{r}
MvLN = ggplot(MidLow) +aes(NBI,color=Height, fill=Height) +geom_histogram(aes(y=..density..), alpha=0.5, position="identity")+ geom_density(alpha=.2) + ylab("Frequency") + xlab("NBI") + ggtitle("Nitrogen by Height") +theme_bw() +theme(plot.title = element_text(hjust = 0.5)); MvLN

AMLN = lm(Mid$NBI ~ Low$NBI)
anova(AMLN)
summary(AMLN)
```
...
#Anth Mean Plot
FMA2 <-ggplot(Dat12) +aes(x = Tree.ID, y = Anth) + geom_point(colour = "turquoise3") +geom_hline(yintercept = mean(Dat12$Anth), colour = "orchid3")+ ylab("Anthocyanin") + xlab("Tree ID") + ggtitle("Anthocyanin of F1 Samples After Correction")+theme_bw()+theme(plot.title = element_text(hjust = 0.5))
...
#Chl Mean Plot
FMC2 <-ggplot(Dat12) +aes(x = Tree.ID, y = Chl) + geom_point(colour = "turquoise3") +geom_hline(yintercept = mean(Dat12$Chl), colour = "orchid3")+ ylab("Chlorophyll") + xlab("Tree ID") + ggtitle("Chlorophyll of F1 Samples After Correction")+theme_bw()+theme(plot.title = element_text(hjust = 0.5))
...
#Flav Mean Plot
FMF2 <-ggplot(Dat12) +aes(x = Tree.ID, y = Flav) + geom_point(colour = "turquoise3") +geom_hline(yintercept = mean(Dat12$Flav), colour = "orchid3")+ ylab("Flavonol") + xlab("Tree ID") + ggtitle("Flavonol of F1 Samples After Correction")+theme_bw()+theme(plot.title = element_text(hjust = 0.5))
...
#NBI Mean Plot
FMN2 <-ggplot(Dat12) +aes(x = Tree.ID, y = NBI) + geom_point(colour = "turquoise3") +geom_hline(yintercept = mean(Dat12$NBI), colour = "orchid3")+ ylab("Nitrogen") + xlab("Tree ID") + ggtitle("Nitrogen of F1 Samples After Correction")+theme_bw()+theme(plot.title = element_text(hjust = 0.5))
...
anova(H09C)
summary(H09C)$r.squared

H09F = lm(H089$Flav ~ H089$Height09)
anova(H09F)
summary(H09F)$r.squared

H09N = lm(H089$NBI ~ H089$Height09)
anova(H09N)
summary(H09N)$r.squared
```
...
anova(H0A)
summary(H0A)$r.squared

H0C = lm(H089$Chl ~ H089$Diff)
anova(H0C)
summary(H0C)$r.squared

H0F = lm(H089$Flav ~ H089$Diff)
anova(H0F)
summary(H0F)$r.squared

H0N = lm(H089$NBI ~ H089$Diff)
anova(H0N)
summary(H0N)$r.squared
```
...
anova(HRA8)
summary(HRA8)$r.squared

HRA9 = lm(H0892$Height09 ~ H0892$Row)
anova(HRA9)
summary(HRA9)$r.squared

HRAD = lm(H0892$Diff ~ H0892$Row)
anova(HRAD)
summary(HRAD)$r.squared
```
...
anova(An1)
summary(An1)$r.squared

An2 = lm(HData$F8 ~ HData$Chl)
anova(An2)
summary(An2)$r.squared

An3 = lm(HData$F8 ~ HData$Flav)
anova(An3)
summary(An3)$r.squared

An4 = lm(HData$F8 ~ HData$NBI)
anova(An4)
summary(An4)$r.squared
```
...
anova(An5)
summary(An5)$r.squared

An6 = lm(HData$F9 ~ HData$Chl)
anova(An6)
summary(An6)$r.squared

An7 = lm(HData$F9 ~ HData$Flav)
anova(An7)
summary(An7)$r.squared

An8 = lm(HData$F9 ~ HData$NBI)
anova(An8)
summary(An8)$r.squared
```
...
anova(An9)
An9R = summary(An9)$r.squared

An10 = lm(HData$FDiff ~ HData$Chl)
anova(An10)
An10R = summary(An10)$r.squared

An11 = lm(HData$FDiff ~ HData$Flav)
anova(An11)
An11R = summary(An11)$r.squared

An12 = lm(HData$FDiff ~ HData$NBI)
anova(An12)
An12R = summary(An12)$r.squared

#RSquared = c(An10R,An11R,An12R)
#Year = c("2018","2019","Difference")
#cbind(Year,RSquared14)
```
...
FF8 = summary(Flower$F8)
FF9 = summary(Flower$F9)
FFD = summary(Flower$FD)
rbind(FF8,FF9,FFD)
...
anova(FH8)
summary(FH8)$r.squared

FH9 = lm(Flower$F9 ~ Flower$Flower)
anova(FH9)
summary(FH9)$r.squared

FD = lm(Flower$FDiff ~ Flower$Flower)
anova(FD)
summary(FD)$r.squared
```