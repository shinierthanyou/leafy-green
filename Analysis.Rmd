...
FSChl <- ggplot(smry) + aes(x = Tree.ID, y = Chl) + geom_point() +geom_hline(yintercept = mean(smry$Chl)) + ylab("Chlorophyll Measure") + xlab("Tree ID") + ggtitle("Chlorophyll of F1 population")
