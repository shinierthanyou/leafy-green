...
```{r}
t.test(FLWR0$HDiff, FLWR1$HDiff)
t.test(FLWR0$HDiff, FLWR2$HDiff)
t.test(FLWR0$HDiff, FLWR3$HDiff)
t.test(FLWR1$HDiff, FLWR2$HDiff)
t.test(FLWR1$HDiff, FLWR3$HDiff)
t.test(FLWR2$HDiff, FLWR3$HDiff)
...
Cor191 = ggplot(F1) +aes(x = H195, y = HDiff) + geom_point(colour = "turquoise3", shape = 1) + ylab("Height Difference") + xlab("Height 2018") + ggtitle("2018 Height and Height Difference 2018-19")+theme_bw()+theme(plot.title = element_text(hjust = 0.5))+geom_smooth()
